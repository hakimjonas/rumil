 ...
 *
 * VERIFIED FINDINGS (with 4MB stack - CI uses SBT_OPTS="-Xss4m"):
 *
 ...
 * - ✅ 20k levels: PASS
 *
 * The practical ceiling is ~7 million sequential parsers with 4MB stack.
 * Real-world grammars have combinator depths < 100, giving a safety margin
 * of 70,000x.
 */
class StackSafetyLimitTests extends munit.FunSuite {
  ...
  // These tests run in CI with SBT_OPTS="-Xss4m"
  ...
  // Million-scale tests - verify extreme capacity locally
