...
object MemoizationBenchmarksRigorous {
  ...
  /** Run a benchmark with proper warmup and multiple iterations. Returns measurements in
    * milliseconds.
    */
  def runBenchmark(
    name: String,
