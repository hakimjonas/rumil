...
import net.ghoula.sarati.ast.yaml.*
...
/** Parses a YAML document from a string.
  ...
  *
  * Note: This is a simplified parser focusing on common YAML features. Full YAML 1.2 spec includes
  * anchors, aliases, tags, and more.
  *
  * @param input
  *   YAML text
  * @return
  *   Result containing parsed YAML document
  */
