...
/** A CSV document is a list of records (rows). Each record is a list of fields (strings).
  *
  * Example:
  * {{{
  * List(
...
/** Formats a CSV document => a string.
  *
  * @param doc
  *   The CSV document to format
  * @param config
  *   CSV configuration (uses delimiter and quote)
  * @return
  *   String representation of the CSV
  */
